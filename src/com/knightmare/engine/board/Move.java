...
import static com.knightmare.engine.board.Board.*;
...
public abstract class Move {
    ...
    public Board execute() {
        ...
        builder.addAllPlaceablePieces(this.board.getPlaceableWhitePieces(), this.board.getPlaceableBlackPieces());
    ...
    public static final class MajorMove extends Move {
        ...
        public String toString(){
            //TODO fix toString method implementation
    ...
    public static class MajorAttackMove extends AttackMove {
        ...
        //TODO Override execute method for attack moves (placeable pieces)
    ...
    public static final class PlacementMove extends Move {

        public PlacementMove(final Board board,
                             final Piece movedPiece,
                             final int destinationCoordinate) {
            super(board, movedPiece, destinationCoordinate);
        }  
    ...
    public static final class PawnEnPassantAttackMove extends PawnAttackMove {
        ...
        public Board execute(){
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            builder.addPlaceablePiece(this.getAttackedPiece());
            builder.addAllPlaceablePieces(this.board.getPlaceableWhitePieces(), this.board.getPlaceableBlackPieces());
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
